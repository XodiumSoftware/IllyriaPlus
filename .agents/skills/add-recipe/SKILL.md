---
name: add-recipe
description: Scaffolds a new RecipeInterface object under recipes/ and registers it in the main plugin class.
---
...
1. Create `IllyriaCore/src/recipes/<Name>Recipe.kt` using the template below.
...
```kotlin
package <project.package>.recipes
