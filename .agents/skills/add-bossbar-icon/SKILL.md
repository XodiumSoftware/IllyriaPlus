...
- Placing the source PNG texture into `IllyriaResourcePack/assets/illyriacore/textures/font/`
...
2. Place the texture at `IllyriaResourcePack/assets/illyriacore/textures/font/{name}.png`.
...
- Keep bossbar icons namespaced under `illyriacore:font/`
