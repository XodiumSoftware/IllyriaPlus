...
/** Yapetto painting variant: randomtickspeed. */
@Suppress("UnstableApiUsage")
internal object RandomtickspeedPainting : PaintingInterface {
    override fun invoke(builder: PaintingVariantRegistryEntry.Builder): PaintingVariantRegistryEntry.Builder =
        builder
            .assetId(Key.key(YAPETTO, "randomtickspeed"))
            .width(2)
            .height(3)
            .title(MM.deserialize("randomtickspeed".snakeToProperCase()))
