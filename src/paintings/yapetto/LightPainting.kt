...
/** Yapetto painting variant: light. */
@Suppress("UnstableApiUsage")
internal object LightPainting : PaintingInterface {
    override fun invoke(builder: PaintingVariantRegistryEntry.Builder): PaintingVariantRegistryEntry.Builder =
        builder
            .assetId(Key.key(YAPETTO, "light"))
            .width(2)
            .height(2)
            .title(MM.deserialize("light".snakeToProperCase()))
