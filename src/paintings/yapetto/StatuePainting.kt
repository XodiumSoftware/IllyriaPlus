...
/** Yapetto painting variant: statue. */
@Suppress("UnstableApiUsage")
internal object StatuePainting : PaintingInterface {
    override fun invoke(builder: PaintingVariantRegistryEntry.Builder): PaintingVariantRegistryEntry.Builder =
        builder
            .assetId(Key.key(YAPETTO, "statue"))
            .width(4)
            .height(3)
            .title(MM.deserialize("statue".snakeToProperCase()))
