...
/** Yapetto painting variant: rosemalling. */
@Suppress("UnstableApiUsage")
internal object RosemallingPainting : PaintingInterface {
    override fun invoke(builder: PaintingVariantRegistryEntry.Builder): PaintingVariantRegistryEntry.Builder =
        builder
            .assetId(Key.key(YAPETTO, "rosemalling"))
            .width(1)
            .height(2)
            .title(MM.deserialize("rosemalling".snakeToProperCase()))
