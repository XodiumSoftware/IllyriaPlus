...
/** Yapetto painting variant: storm. */
@Suppress("UnstableApiUsage")
internal object StormPainting : PaintingInterface {
    override fun invoke(builder: PaintingVariantRegistryEntry.Builder): PaintingVariantRegistryEntry.Builder =
        builder
            .assetId(Key.key(YAPETTO, "storm"))
            .width(4)
            .height(3)
            .title(MM.deserialize("storm".snakeToProperCase()))
