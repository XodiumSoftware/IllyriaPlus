...
/** Yapetto painting variant: boscage. */
@Suppress("UnstableApiUsage")
internal object BoscagePainting : PaintingInterface {
    override fun invoke(builder: PaintingVariantRegistryEntry.Builder): PaintingVariantRegistryEntry.Builder =
        builder
            .assetId(Key.key(YAPETTO, "boscage"))
            .width(3)
            .height(1)
            .title(MM.deserialize("boscage".snakeToProperCase()))
