...
/** Yapetto painting variant: waves. */
@Suppress("UnstableApiUsage")
internal object WavesPainting : PaintingInterface {
    override fun invoke(builder: PaintingVariantRegistryEntry.Builder): PaintingVariantRegistryEntry.Builder =
        builder
            .assetId(Key.key(YAPETTO, "waves"))
            .width(3)
            .height(3)
            .title(MM.deserialize("waves".snakeToProperCase()))
