...
/** Yapetto painting variant: prickle. */
@Suppress("UnstableApiUsage")
internal object PricklePainting : PaintingInterface {
    override fun invoke(builder: PaintingVariantRegistryEntry.Builder): PaintingVariantRegistryEntry.Builder =
        builder
            .assetId(Key.key(YAPETTO, "prickle"))
            .width(1)
            .height(4)
            .title(MM.deserialize("prickle".snakeToProperCase()))
