...
/** Yapetto painting variant: moonlight tower. */
@Suppress("UnstableApiUsage")
internal object MoonlightTowerPainting : PaintingInterface {
    override fun invoke(builder: PaintingVariantRegistryEntry.Builder): PaintingVariantRegistryEntry.Builder =
        builder
            .assetId(Key.key(YAPETTO, "moonlight_tower"))
            .width(2)
            .height(3)
            .title(MM.deserialize("moonlight_tower".snakeToProperCase()))
