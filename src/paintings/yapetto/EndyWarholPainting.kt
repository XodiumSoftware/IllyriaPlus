...
/** Yapetto painting variant: endy warhol. */
@Suppress("UnstableApiUsage")
internal object EndyWarholPainting : PaintingInterface {
    override fun invoke(builder: PaintingVariantRegistryEntry.Builder): PaintingVariantRegistryEntry.Builder =
        builder
            .assetId(Key.key(YAPETTO, "endy_warhol"))
            .width(3)
            .height(3)
            .title(MM.deserialize("endy_warhol".snakeToProperCase()))
