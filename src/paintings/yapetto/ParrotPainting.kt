...
/** Yapetto painting variant: parrot. */
@Suppress("UnstableApiUsage")
internal object ParrotPainting : PaintingInterface {
    override fun invoke(builder: PaintingVariantRegistryEntry.Builder): PaintingVariantRegistryEntry.Builder =
        builder
            .assetId(Key.key(YAPETTO, "parrot"))
            .width(2)
            .height(2)
            .title(MM.deserialize("parrot".snakeToProperCase()))
