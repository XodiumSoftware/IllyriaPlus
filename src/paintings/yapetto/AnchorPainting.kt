...
/** Yapetto painting variant: anchor. */
@Suppress("UnstableApiUsage")
internal object AnchorPainting : PaintingInterface {
    override fun invoke(builder: PaintingVariantRegistryEntry.Builder): PaintingVariantRegistryEntry.Builder =
        builder
            .assetId(Key.key(YAPETTO, "anchor"))
            .width(3)
            .height(3)
            .title(MM.deserialize("anchor".snakeToProperCase()))
