...
/** Yapetto painting variant: caricature. */
@Suppress("UnstableApiUsage")
internal object CaricaturePainting : PaintingInterface {
    override fun invoke(builder: PaintingVariantRegistryEntry.Builder): PaintingVariantRegistryEntry.Builder =
        builder
            .assetId(Key.key(YAPETTO, "caricature"))
            .width(2)
            .height(4)
            .title(MM.deserialize("caricature".snakeToProperCase()))
