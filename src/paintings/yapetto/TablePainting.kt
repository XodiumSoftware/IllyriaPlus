...
/** Yapetto painting variant: table. */
@Suppress("UnstableApiUsage")
internal object TablePainting : PaintingInterface {
    override fun invoke(builder: PaintingVariantRegistryEntry.Builder): PaintingVariantRegistryEntry.Builder =
        builder
            .assetId(Key.key(YAPETTO, "table"))
            .width(1)
            .height(4)
            .title(MM.deserialize("table".snakeToProperCase()))
