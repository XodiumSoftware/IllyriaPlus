...
/** Yapetto painting variant: medley. */
@Suppress("UnstableApiUsage")
internal object MedleyPainting : PaintingInterface {
    override fun invoke(builder: PaintingVariantRegistryEntry.Builder): PaintingVariantRegistryEntry.Builder =
        builder
            .assetId(Key.key(YAPETTO, "medley"))
            .width(2)
            .height(1)
            .title(MM.deserialize("medley".snakeToProperCase()))
