...
/** Yapetto painting variant: shapes. */
@Suppress("UnstableApiUsage")
internal object ShapesPainting : PaintingInterface {
    override fun invoke(builder: PaintingVariantRegistryEntry.Builder): PaintingVariantRegistryEntry.Builder =
        builder
            .assetId(Key.key(YAPETTO, "shapes"))
            .width(1)
            .height(3)
            .title(MM.deserialize("shapes".snakeToProperCase()))
