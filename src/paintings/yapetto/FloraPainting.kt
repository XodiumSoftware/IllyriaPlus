...
/** Yapetto painting variant: flora. */
@Suppress("UnstableApiUsage")
internal object FloraPainting : PaintingInterface {
    override fun invoke(builder: PaintingVariantRegistryEntry.Builder): PaintingVariantRegistryEntry.Builder =
        builder
            .assetId(Key.key(YAPETTO, "flora"))
            .width(2)
            .height(2)
            .title(MM.deserialize("flora".snakeToProperCase()))
