...
/** Yapetto painting variant: ancestor. */
@Suppress("UnstableApiUsage")
internal object AncestorPainting : PaintingInterface {
    override fun invoke(builder: PaintingVariantRegistryEntry.Builder): PaintingVariantRegistryEntry.Builder =
        builder
            .assetId(Key.key(YAPETTO, "ancestor"))
            .width(3)
            .height(2)
            .title(MM.deserialize("ancestor".snakeToProperCase()))
