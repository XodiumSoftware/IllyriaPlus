...
/** Yapetto painting variant: still life. */
@Suppress("UnstableApiUsage")
internal object StillLifePainting : PaintingInterface {
    override fun invoke(builder: PaintingVariantRegistryEntry.Builder): PaintingVariantRegistryEntry.Builder =
        builder
            .assetId(Key.key(YAPETTO, "still_life"))
            .width(1)
            .height(1)
            .title(MM.deserialize("still_life".snakeToProperCase()))
