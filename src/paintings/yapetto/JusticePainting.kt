...
/** Yapetto painting variant: justice. */
@Suppress("UnstableApiUsage")
internal object JusticePainting : PaintingInterface {
    override fun invoke(builder: PaintingVariantRegistryEntry.Builder): PaintingVariantRegistryEntry.Builder =
        builder
            .assetId(Key.key(YAPETTO, "justice"))
            .width(4)
            .height(4)
            .title(MM.deserialize("justice".snakeToProperCase()))
