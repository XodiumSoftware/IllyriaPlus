...
/** Yapetto painting variant: oak door. */
@Suppress("UnstableApiUsage")
internal object OakDoorPainting : PaintingInterface {
    override fun invoke(builder: PaintingVariantRegistryEntry.Builder): PaintingVariantRegistryEntry.Builder =
        builder
            .assetId(Key.key(YAPETTO, "oak_door"))
            .width(3)
            .height(4)
            .title(MM.deserialize("oak_door".snakeToProperCase()))
