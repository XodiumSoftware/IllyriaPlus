...
/** Yapetto painting variant: escapeless. */
@Suppress("UnstableApiUsage")
internal object EscapelessPainting : PaintingInterface {
    override fun invoke(builder: PaintingVariantRegistryEntry.Builder): PaintingVariantRegistryEntry.Builder =
        builder
            .assetId(Key.key(YAPETTO, "escapeless"))
            .width(2)
            .height(4)
            .title(MM.deserialize("escapeless".snakeToProperCase()))
