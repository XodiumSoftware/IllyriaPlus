...
/** Yapetto painting variant: cloth. */
@Suppress("UnstableApiUsage")
internal object ClothPainting : PaintingInterface {
    override fun invoke(builder: PaintingVariantRegistryEntry.Builder): PaintingVariantRegistryEntry.Builder =
        builder
            .assetId(Key.key(YAPETTO, "cloth"))
            .width(4)
            .height(4)
            .title(MM.deserialize("cloth".snakeToProperCase()))
