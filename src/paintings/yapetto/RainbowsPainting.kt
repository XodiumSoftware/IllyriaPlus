...
/** Yapetto painting variant: rainbows. */
@Suppress("UnstableApiUsage")
internal object RainbowsPainting : PaintingInterface {
    override fun invoke(builder: PaintingVariantRegistryEntry.Builder): PaintingVariantRegistryEntry.Builder =
        builder
            .assetId(Key.key(YAPETTO, "rainbows"))
            .width(4)
            .height(3)
            .title(MM.deserialize("rainbows".snakeToProperCase()))
