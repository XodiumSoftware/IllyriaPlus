...
/** Yapetto painting variant: frost. */
@Suppress("UnstableApiUsage")
internal object FrostPainting : PaintingInterface {
    override fun invoke(builder: PaintingVariantRegistryEntry.Builder): PaintingVariantRegistryEntry.Builder =
        builder
            .assetId(Key.key(YAPETTO, "frost"))
            .width(2)
            .height(2)
            .title(MM.deserialize("frost".snakeToProperCase()))
