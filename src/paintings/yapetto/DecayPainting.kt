...
/** Yapetto painting variant: decay. */
@Suppress("UnstableApiUsage")
internal object DecayPainting : PaintingInterface {
    override fun invoke(builder: PaintingVariantRegistryEntry.Builder): PaintingVariantRegistryEntry.Builder =
        builder
            .assetId(Key.key(YAPETTO, "decay"))
            .width(2)
            .height(2)
            .title(MM.deserialize("decay".snakeToProperCase()))
