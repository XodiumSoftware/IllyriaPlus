...
/** Yapetto painting variant: awful housing. */
@Suppress("UnstableApiUsage")
internal object AwfulHousingPainting : PaintingInterface {
    override fun invoke(builder: PaintingVariantRegistryEntry.Builder): PaintingVariantRegistryEntry.Builder =
        builder
            .assetId(Key.key(YAPETTO, "awful_housing"))
            .width(2)
            .height(4)
            .title(MM.deserialize("awful_housing".snakeToProperCase()))
