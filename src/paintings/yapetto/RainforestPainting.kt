...
/** Yapetto painting variant: rainforest. */
@Suppress("UnstableApiUsage")
internal object RainforestPainting : PaintingInterface {
    override fun invoke(builder: PaintingVariantRegistryEntry.Builder): PaintingVariantRegistryEntry.Builder =
        builder
            .assetId(Key.key(YAPETTO, "rainforest"))
            .width(2)
            .height(1)
            .title(MM.deserialize("rainforest".snakeToProperCase()))
