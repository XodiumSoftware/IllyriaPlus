...
/** Yapetto painting variant: alpha. */
@Suppress("UnstableApiUsage")
internal object AlphaPainting : PaintingInterface {
    override fun invoke(builder: PaintingVariantRegistryEntry.Builder): PaintingVariantRegistryEntry.Builder =
        builder
            .assetId(Key.key(YAPETTO, "alpha"))
            .width(1)
            .height(1)
            .title(MM.deserialize("alpha".snakeToProperCase()))
