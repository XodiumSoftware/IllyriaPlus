...
/** Yapetto painting variant: unwrap. */
@Suppress("UnstableApiUsage")
internal object UnwrapPainting : PaintingInterface {
    override fun invoke(builder: PaintingVariantRegistryEntry.Builder): PaintingVariantRegistryEntry.Builder =
        builder
            .assetId(Key.key(YAPETTO, "unwrap"))
            .width(3)
            .height(2)
            .title(MM.deserialize("unwrap".snakeToProperCase()))
