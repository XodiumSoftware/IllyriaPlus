...
/** Yapetto painting variant: heartbeat. */
@Suppress("UnstableApiUsage")
internal object HeartbeatPainting : PaintingInterface {
    override fun invoke(builder: PaintingVariantRegistryEntry.Builder): PaintingVariantRegistryEntry.Builder =
        builder
            .assetId(Key.key(YAPETTO, "heartbeat"))
            .width(2)
            .height(2)
            .title(MM.deserialize("heartbeat".snakeToProperCase()))
