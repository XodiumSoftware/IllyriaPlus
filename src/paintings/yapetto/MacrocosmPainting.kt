...
/** Yapetto painting variant: macrocosm. */
@Suppress("UnstableApiUsage")
internal object MacrocosmPainting : PaintingInterface {
    override fun invoke(builder: PaintingVariantRegistryEntry.Builder): PaintingVariantRegistryEntry.Builder =
        builder
            .assetId(Key.key(YAPETTO, "macrocosm"))
            .width(2)
            .height(2)
            .title(MM.deserialize("macrocosm".snakeToProperCase()))
