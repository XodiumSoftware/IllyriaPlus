...
/** Yapetto painting variant: pixel gobelin. */
@Suppress("UnstableApiUsage")
internal object PixelGobelinPainting : PaintingInterface {
    override fun invoke(builder: PaintingVariantRegistryEntry.Builder): PaintingVariantRegistryEntry.Builder =
        builder
            .assetId(Key.key(YAPETTO, "pixel_gobelin"))
            .width(2)
            .height(3)
            .title(MM.deserialize("pixel_gobelin".snakeToProperCase()))
