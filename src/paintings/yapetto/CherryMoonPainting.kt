...
/** Yapetto painting variant: cherry moon. */
@Suppress("UnstableApiUsage")
internal object CherryMoonPainting : PaintingInterface {
    override fun invoke(builder: PaintingVariantRegistryEntry.Builder): PaintingVariantRegistryEntry.Builder =
        builder
            .assetId(Key.key(YAPETTO, "cherry_moon"))
            .width(2)
            .height(4)
            .title(MM.deserialize("cherry_moon".snakeToProperCase()))
