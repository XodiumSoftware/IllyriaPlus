...
/** Yapetto painting variant: underworld. */
@Suppress("UnstableApiUsage")
internal object UnderworldPainting : PaintingInterface {
    override fun invoke(builder: PaintingVariantRegistryEntry.Builder): PaintingVariantRegistryEntry.Builder =
        builder
            .assetId(Key.key(YAPETTO, "underworld"))
            .width(3)
            .height(4)
            .title(MM.deserialize("underworld".snakeToProperCase()))
