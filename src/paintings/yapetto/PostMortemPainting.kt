...
/** Yapetto painting variant: post mortem. */
@Suppress("UnstableApiUsage")
internal object PostMortemPainting : PaintingInterface {
    override fun invoke(builder: PaintingVariantRegistryEntry.Builder): PaintingVariantRegistryEntry.Builder =
        builder
            .assetId(Key.key(YAPETTO, "post_mortem"))
            .width(2)
            .height(1)
            .title(MM.deserialize("post_mortem".snakeToProperCase()))
