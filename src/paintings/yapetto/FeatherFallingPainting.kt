...
/** Yapetto painting variant: feather falling. */
@Suppress("UnstableApiUsage")
internal object FeatherFallingPainting : PaintingInterface {
    override fun invoke(builder: PaintingVariantRegistryEntry.Builder): PaintingVariantRegistryEntry.Builder =
        builder
            .assetId(Key.key(YAPETTO, "feather_falling"))
            .width(4)
            .height(3)
            .title(MM.deserialize("feather_falling".snakeToProperCase()))
