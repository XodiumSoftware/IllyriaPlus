...
/** Yapetto painting variant: perennial. */
@Suppress("UnstableApiUsage")
internal object PerennialPainting : PaintingInterface {
    override fun invoke(builder: PaintingVariantRegistryEntry.Builder): PaintingVariantRegistryEntry.Builder =
        builder
            .assetId(Key.key(YAPETTO, "perennial"))
            .width(1)
            .height(1)
            .title(MM.deserialize("perennial".snakeToProperCase()))
