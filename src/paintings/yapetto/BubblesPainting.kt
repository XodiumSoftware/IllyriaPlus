...
/** Yapetto painting variant: bubbles. */
@Suppress("UnstableApiUsage")
internal object BubblesPainting : PaintingInterface {
    override fun invoke(builder: PaintingVariantRegistryEntry.Builder): PaintingVariantRegistryEntry.Builder =
        builder
            .assetId(Key.key(YAPETTO, "bubbles"))
            .width(1)
            .height(1)
            .title(MM.deserialize("bubbles".snakeToProperCase()))
