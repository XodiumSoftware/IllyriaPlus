...
/** Yapetto painting variant: an intruder. */
@Suppress("UnstableApiUsage")
internal object AnIntruderPainting : PaintingInterface {
    override fun invoke(builder: PaintingVariantRegistryEntry.Builder): PaintingVariantRegistryEntry.Builder =
        builder
            .assetId(Key.key(YAPETTO, "an_intruder"))
            .width(2)
            .height(3)
            .title(MM.deserialize("an_intruder".snakeToProperCase()))
