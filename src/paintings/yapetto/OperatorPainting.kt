...
/** Yapetto painting variant: operator. */
@Suppress("UnstableApiUsage")
internal object OperatorPainting : PaintingInterface {
    override fun invoke(builder: PaintingVariantRegistryEntry.Builder): PaintingVariantRegistryEntry.Builder =
        builder
            .assetId(Key.key(YAPETTO, "operator"))
            .width(2)
            .height(2)
            .title(MM.deserialize("operator".snakeToProperCase()))
