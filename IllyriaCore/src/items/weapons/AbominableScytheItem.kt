...
/** Represents a Abominable Scythe. */
internal object AbominableScytheItem : ItemInterface {
    override val key: NamespacedKey = NamespacedKey(instance, "abominablescythe")
    ...
    override fun invoke(): ItemStack =
        ItemStack.of(Material.NETHERITE_SPEAR).apply {
            if (!hasData(DataComponentTypes.CUSTOM_NAME) && !hasData(DataComponentTypes.ITEM_NAME)) {
                setData(DataComponentTypes.CUSTOM_NAME, Utils.MM.deserialize("Abominable Scythe"))
            }
