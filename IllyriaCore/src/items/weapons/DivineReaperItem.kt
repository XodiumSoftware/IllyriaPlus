...
/** Represents a Divine Reaper. */
internal object DivineReaperItem : ItemInterface {
    override val key: NamespacedKey = NamespacedKey(instance, "divine_reaper")
    ...
    override fun invoke(): ItemStack =
        ItemStack.of(Material.NETHERITE_SWORD).apply {
            if (!hasData(DataComponentTypes.CUSTOM_NAME) && !hasData(DataComponentTypes.ITEM_NAME)) {
                setData(DataComponentTypes.CUSTOM_NAME, Utils.MM.deserialize("Divine Reaper"))
            }
