...
/** Represents a Ancient Royal Great Sword. */
internal object AncientRoyalGreatSwordItem : ItemInterface {
    override val key: NamespacedKey = NamespacedKey(instance, "ancient_royal_great_sword")
    ...
    override fun invoke(): ItemStack =
        ItemStack.of(Material.NETHERITE_SWORD).apply {
            if (!hasData(DataComponentTypes.CUSTOM_NAME) && !hasData(DataComponentTypes.ITEM_NAME)) {
                setData(DataComponentTypes.CUSTOM_NAME, Utils.MM.deserialize("Ancient Royal Great Sword"))
            }
