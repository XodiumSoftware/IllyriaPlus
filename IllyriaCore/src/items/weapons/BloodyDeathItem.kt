...
/** Represents a Bloody Death. */
internal object BloodyDeathItem : ItemInterface {
    override val key: NamespacedKey = NamespacedKey(instance, "bloodydeath")
    ...
    override fun invoke(): ItemStack =
        ItemStack.of(Material.NETHERITE_SWORD).apply {
            if (!hasData(DataComponentTypes.CUSTOM_NAME) && !hasData(DataComponentTypes.ITEM_NAME)) {
                setData(DataComponentTypes.CUSTOM_NAME, Utils.MM.deserialize("Bloody Death"))
            }
