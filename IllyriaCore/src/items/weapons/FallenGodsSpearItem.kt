...
/** Represents a Fallen God's Spear. */
internal object FallenGodsSpearItem : ItemInterface {
    override val key: NamespacedKey = NamespacedKey(instance, "fallengodspear")
    ...
    override fun invoke(): ItemStack =
        ItemStack.of(Material.NETHERITE_SPEAR).apply {
            if (!hasData(DataComponentTypes.CUSTOM_NAME) && !hasData(DataComponentTypes.ITEM_NAME)) {
                setData(DataComponentTypes.CUSTOM_NAME, Utils.MM.deserialize("Fallen God's Spear"))
            }
