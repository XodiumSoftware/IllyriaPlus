...
/** Represents a Cyber Mantis Blade. */
internal object CyberMantisBladeItem : ItemInterface {
    override val key: NamespacedKey = NamespacedKey(instance, "cybermantisblade")
    ...
    override fun invoke(): ItemStack =
        ItemStack.of(Material.NETHERITE_SWORD).apply {
            if (!hasData(DataComponentTypes.CUSTOM_NAME) && !hasData(DataComponentTypes.ITEM_NAME)) {
                setData(DataComponentTypes.CUSTOM_NAME, Utils.MM.deserialize("Cyber Mantis Blade"))
            }
