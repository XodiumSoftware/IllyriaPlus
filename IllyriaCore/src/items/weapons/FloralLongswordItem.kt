...
/** Represents a Floral Longsword. */
internal object FloralLongswordItem : ItemInterface {
    override val key: NamespacedKey = NamespacedKey(instance, "floral_longsword")
    ...
    override fun invoke(): ItemStack =
        ItemStack.of(Material.NETHERITE_SWORD).apply {
            if (!hasData(DataComponentTypes.CUSTOM_NAME) && !hasData(DataComponentTypes.ITEM_NAME)) {
                setData(DataComponentTypes.CUSTOM_NAME, Utils.MM.deserialize("Floral Longsword"))
            }
