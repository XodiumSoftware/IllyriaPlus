...
/** Represents a Icewhisper. */
internal object IcewhisperItem : ItemInterface {
    override val key: NamespacedKey = NamespacedKey(instance, "icewhisper")
    ...
    override fun invoke(): ItemStack =
        ItemStack.of(Material.NETHERITE_SWORD).apply {
            if (!hasData(DataComponentTypes.CUSTOM_NAME) && !hasData(DataComponentTypes.ITEM_NAME)) {
                setData(DataComponentTypes.CUSTOM_NAME, Utils.MM.deserialize("Icewhisper"))
            }
