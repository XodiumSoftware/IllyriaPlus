...
/** Represents a Power Fuse Sword. */
internal object PowerFuseSwordItem : ItemInterface {
    override val key: NamespacedKey = NamespacedKey(instance, "powerfusesword")
    ...
    override fun invoke(): ItemStack =
        ItemStack.of(Material.NETHERITE_SWORD).apply {
            if (!hasData(DataComponentTypes.CUSTOM_NAME) && !hasData(DataComponentTypes.ITEM_NAME)) {
                setData(DataComponentTypes.CUSTOM_NAME, Utils.MM.deserialize("Power Fuse Sword"))
            }
