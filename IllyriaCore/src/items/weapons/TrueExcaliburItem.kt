...
/** Represents a True Excalibur. */
internal object TrueExcaliburItem : ItemInterface {
    override val key: NamespacedKey = NamespacedKey(instance, "excalibur")
    ...
    override fun invoke(): ItemStack =
        ItemStack.of(Material.NETHERITE_SWORD).apply {
            if (!hasData(DataComponentTypes.CUSTOM_NAME) && !hasData(DataComponentTypes.ITEM_NAME)) {
                setData(DataComponentTypes.CUSTOM_NAME, Utils.MM.deserialize("True Excalibur"))
            }
