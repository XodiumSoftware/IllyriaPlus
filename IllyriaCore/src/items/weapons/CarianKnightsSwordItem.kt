...
/** Represents a Carian Knight's Sword. */
internal object CarianKnightsSwordItem : ItemInterface {
    override val key: NamespacedKey = NamespacedKey(instance, "cariansword")
    ...
    override fun invoke(): ItemStack =
        ItemStack.of(Material.NETHERITE_SWORD).apply {
            if (!hasData(DataComponentTypes.CUSTOM_NAME) && !hasData(DataComponentTypes.ITEM_NAME)) {
                setData(DataComponentTypes.CUSTOM_NAME, Utils.MM.deserialize("Carian Knight's Sword"))
            }
