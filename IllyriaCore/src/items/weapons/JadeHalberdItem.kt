...
/** Represents a Jade Halberd. */
internal object JadeHalberdItem : ItemInterface {
    override val key: NamespacedKey = NamespacedKey(instance, "jadehalberd")
    ...
    override fun invoke(): ItemStack =
        ItemStack.of(Material.NETHERITE_SPEAR).apply {
            if (!hasData(DataComponentTypes.CUSTOM_NAME) && !hasData(DataComponentTypes.ITEM_NAME)) {
                setData(DataComponentTypes.CUSTOM_NAME, Utils.MM.deserialize("Jade Halberd"))
            }
