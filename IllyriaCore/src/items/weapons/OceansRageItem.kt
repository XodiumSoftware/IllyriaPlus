...
/** Represents a Ocean's Rage. */
internal object OceansRageItem : ItemInterface {
    override val key: NamespacedKey = NamespacedKey(instance, "aquantictrident")
    ...
    override fun invoke(): ItemStack =
        ItemStack.of(Material.NETHERITE_SWORD).apply {
            if (!hasData(DataComponentTypes.CUSTOM_NAME) && !hasData(DataComponentTypes.ITEM_NAME)) {
                setData(DataComponentTypes.CUSTOM_NAME, Utils.MM.deserialize("Ocean's Rage"))
            }
