...
/** Represents a Partisan. */
internal object PartisanItem : ItemInterface {
    override val key: NamespacedKey = NamespacedKey(instance, "partisan")
    ...
    override fun invoke(): ItemStack =
        ItemStack.of(Material.NETHERITE_SPEAR).apply {
            if (!hasData(DataComponentTypes.CUSTOM_NAME) && !hasData(DataComponentTypes.ITEM_NAME)) {
                setData(DataComponentTypes.CUSTOM_NAME, Utils.MM.deserialize("Partisan"))
            }
