...
/** Represents a Demonic Cleaver. */
internal object DemonicCleaverItem : ItemInterface {
    override val key: NamespacedKey = NamespacedKey(instance, "demoniccleaver")
    ...
    override fun invoke(): ItemStack =
        ItemStack.of(Material.NETHERITE_SWORD).apply {
            if (!hasData(DataComponentTypes.CUSTOM_NAME) && !hasData(DataComponentTypes.ITEM_NAME)) {
                setData(DataComponentTypes.CUSTOM_NAME, Utils.MM.deserialize("Demonic Cleaver"))
            }
