...
/** Represents a Dark Cleaver. */
internal object DarkCleaverItem : ItemInterface {
    override val key: NamespacedKey = NamespacedKey(instance, "dark_cleaver")
    ...
    override fun invoke(): ItemStack =
        ItemStack.of(Material.NETHERITE_SWORD).apply {
            if (!hasData(DataComponentTypes.CUSTOM_NAME) && !hasData(DataComponentTypes.ITEM_NAME)) {
                setData(DataComponentTypes.CUSTOM_NAME, Utils.MM.deserialize("Dark Cleaver"))
            }
