...
/** Represents a Demon Lord's Sword. */
internal object DemonLordsSwordItem : ItemInterface {
    override val key: NamespacedKey = NamespacedKey(instance, "demonlordsword")
    ...
    override fun invoke(): ItemStack =
        ItemStack.of(Material.NETHERITE_SWORD).apply {
            if (!hasData(DataComponentTypes.CUSTOM_NAME) && !hasData(DataComponentTypes.ITEM_NAME)) {
                setData(DataComponentTypes.CUSTOM_NAME, Utils.MM.deserialize("Demon Lord's Sword"))
            }
