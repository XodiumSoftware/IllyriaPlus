...
/** Represents a Death Knight's Sword. */
internal object DeathKnightsSwordItem : ItemInterface {
    override val key: NamespacedKey = NamespacedKey(instance, "death_knight_sword")
    ...
    override fun invoke(): ItemStack =
        ItemStack.of(Material.NETHERITE_SWORD).apply {
            if (!hasData(DataComponentTypes.CUSTOM_NAME) && !hasData(DataComponentTypes.ITEM_NAME)) {
                setData(DataComponentTypes.CUSTOM_NAME, Utils.MM.deserialize("Death Knight's Sword"))
            }
