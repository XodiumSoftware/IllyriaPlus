...
/** Represents a Terra Blade. */
internal object TerraBladeItem : ItemInterface {
    override val key: NamespacedKey = NamespacedKey(instance, "terrablade")
    ...
    override fun invoke(): ItemStack =
        ItemStack.of(Material.NETHERITE_SWORD).apply {
            if (!hasData(DataComponentTypes.CUSTOM_NAME) && !hasData(DataComponentTypes.ITEM_NAME)) {
                setData(DataComponentTypes.CUSTOM_NAME, Utils.MM.deserialize("Terra Blade"))
            }
