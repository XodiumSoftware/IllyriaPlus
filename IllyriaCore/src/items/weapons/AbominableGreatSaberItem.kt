...
/** Represents a Abominable Great Saber. */
internal object AbominableGreatSaberItem : ItemInterface {
    override val key: NamespacedKey = NamespacedKey(instance, "abominablegreatsaber")
    ...
    override fun invoke(): ItemStack =
        ItemStack.of(Material.NETHERITE_SWORD).apply {
            if (!hasData(DataComponentTypes.CUSTOM_NAME) && !hasData(DataComponentTypes.ITEM_NAME)) {
                setData(DataComponentTypes.CUSTOM_NAME, Utils.MM.deserialize("Abominable Great Saber"))
            }
