...
/** Represents a Thousand Demon Daggers. */
internal object ThousandDemonDaggersItem : ItemInterface {
    override val key: NamespacedKey = NamespacedKey(instance, "thousanddemondaggers")
    ...
    override fun invoke(): ItemStack =
        ItemStack.of(Material.NETHERITE_SWORD).apply {
            if (!hasData(DataComponentTypes.CUSTOM_NAME) && !hasData(DataComponentTypes.ITEM_NAME)) {
                setData(DataComponentTypes.CUSTOM_NAME, Utils.MM.deserialize("Thousand Demon Daggers"))
            }
            ...
            setData(
                ...
                ItemAttributeModifiers
                    ...
                    .addModifier(
                        ...
                        AttributeModifier(key, 7.0, AttributeModifier.Operation.ADD_NUMBER),
                        EquipmentSlotGroup.MAINHAND,
                    ).addModifier(
                        Attribute.ATTACK_SPEED,
                        AttributeModifier(key, 1.9, AttributeModifier.Operation.ADD_NUMBER),
                        EquipmentSlotGroup.MAINHAND,
                    ).build(),
            )
