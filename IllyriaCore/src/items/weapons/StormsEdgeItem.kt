...
/** Represents a Storm's Edge. */
internal object StormsEdgeItem : ItemInterface {
    override val key: NamespacedKey = NamespacedKey(instance, "storms_edge")
    ...
    override fun invoke(): ItemStack =
        ItemStack.of(Material.NETHERITE_SWORD).apply {
            if (!hasData(DataComponentTypes.CUSTOM_NAME) && !hasData(DataComponentTypes.ITEM_NAME)) {
                setData(DataComponentTypes.CUSTOM_NAME, Utils.MM.deserialize("Storm's Edge"))
            }
