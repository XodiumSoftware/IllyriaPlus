...
/** Represents a Tengen's Blade. */
internal object TengensBladeItem : ItemInterface {
    override val key: NamespacedKey = NamespacedKey(instance, "tengensblade")
    ...
    override fun invoke(): ItemStack =
        ItemStack.of(Material.NETHERITE_SWORD).apply {
            if (!hasData(DataComponentTypes.CUSTOM_NAME) && !hasData(DataComponentTypes.ITEM_NAME)) {
                setData(DataComponentTypes.CUSTOM_NAME, Utils.MM.deserialize("Tengen's Blade"))
            }
