...
/** Represents a Fallen God's Sword. */
internal object FallenGodsSwordItem : ItemInterface {
    override val key: NamespacedKey = NamespacedKey(instance, "fallengodsword")
    ...
    override fun invoke(): ItemStack =
        ItemStack.of(Material.NETHERITE_SWORD).apply {
            if (!hasData(DataComponentTypes.CUSTOM_NAME) && !hasData(DataComponentTypes.ITEM_NAME)) {
                setData(DataComponentTypes.CUSTOM_NAME, Utils.MM.deserialize("Fallen God's Sword"))
            }
