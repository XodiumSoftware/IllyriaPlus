...
/** Represents a Pharaoh's Treasure. */
internal object PharaohsTreasureItem : ItemInterface {
    override val key: NamespacedKey = NamespacedKey(instance, "pharaohs_treasure")
    ...
    override fun invoke(): ItemStack =
        ItemStack.of(Material.NETHERITE_SWORD).apply {
            if (!hasData(DataComponentTypes.CUSTOM_NAME) && !hasData(DataComponentTypes.ITEM_NAME)) {
                setData(DataComponentTypes.CUSTOM_NAME, Utils.MM.deserialize("Pharaoh's Treasure"))
            }
