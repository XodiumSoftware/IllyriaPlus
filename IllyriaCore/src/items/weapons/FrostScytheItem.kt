...
/** Represents a Frost Scythe. */
internal object FrostScytheItem : ItemInterface {
    override val key: NamespacedKey = NamespacedKey(instance, "frostscythe")
    ...
    override fun invoke(): ItemStack =
        ItemStack.of(Material.NETHERITE_SPEAR).apply {
            if (!hasData(DataComponentTypes.CUSTOM_NAME) && !hasData(DataComponentTypes.ITEM_NAME)) {
                setData(DataComponentTypes.CUSTOM_NAME, Utils.MM.deserialize("Frost Scythe"))
            }
