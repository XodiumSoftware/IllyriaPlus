...
/** Represents a Cybernetic Katana. */
internal object CyberneticKatanaItem : ItemInterface {
    override val key: NamespacedKey = NamespacedKey(instance, "cybernetickatana")
    ...
    override fun invoke(): ItemStack =
        ItemStack.of(Material.NETHERITE_SWORD).apply {
            if (!hasData(DataComponentTypes.CUSTOM_NAME) && !hasData(DataComponentTypes.ITEM_NAME)) {
                setData(DataComponentTypes.CUSTOM_NAME, Utils.MM.deserialize("Cybernetic Katana"))
            }
