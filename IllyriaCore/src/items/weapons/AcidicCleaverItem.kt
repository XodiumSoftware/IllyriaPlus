...
/** Represents a Acidic Cleaver. */
internal object AcidicCleaverItem : ItemInterface {
    override val key: NamespacedKey = NamespacedKey(instance, "aciddemon")
    ...
    override fun invoke(): ItemStack =
        ItemStack.of(Material.NETHERITE_SWORD).apply {
            if (!hasData(DataComponentTypes.CUSTOM_NAME) && !hasData(DataComponentTypes.ITEM_NAME)) {
                setData(DataComponentTypes.CUSTOM_NAME, Utils.MM.deserialize("Acidic Cleaver"))
            }
