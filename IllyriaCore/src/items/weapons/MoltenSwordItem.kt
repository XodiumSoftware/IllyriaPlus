...
/** Represents a Molten Sword. */
internal object MoltenSwordItem : ItemInterface {
    override val key: NamespacedKey = NamespacedKey(instance, "moltensword")
    ...
    override fun invoke(): ItemStack =
        ItemStack.of(Material.NETHERITE_SWORD).apply {
            if (!hasData(DataComponentTypes.CUSTOM_NAME) && !hasData(DataComponentTypes.ITEM_NAME)) {
                setData(DataComponentTypes.CUSTOM_NAME, Utils.MM.deserialize("Molten Sword"))
            }
