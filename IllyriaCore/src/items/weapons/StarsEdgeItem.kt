...
/** Represents a Star's Edge. */
internal object StarsEdgeItem : ItemInterface {
    override val key: NamespacedKey = NamespacedKey(instance, "stars_edge")
    ...
    override fun invoke(): ItemStack =
        ItemStack.of(Material.NETHERITE_SWORD).apply {
            if (!hasData(DataComponentTypes.CUSTOM_NAME) && !hasData(DataComponentTypes.ITEM_NAME)) {
                setData(DataComponentTypes.CUSTOM_NAME, Utils.MM.deserialize("Star's Edge"))
            }
