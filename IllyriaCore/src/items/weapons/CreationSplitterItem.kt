...
/** Represents a Creation Splitter. */
internal object CreationSplitterItem : ItemInterface {
    override val key: NamespacedKey = NamespacedKey(instance, "creationsplitter")
    ...
    override fun invoke(): ItemStack =
        ItemStack.of(Material.NETHERITE_SWORD).apply {
            if (!hasData(DataComponentTypes.CUSTOM_NAME) && !hasData(DataComponentTypes.ITEM_NAME)) {
                setData(DataComponentTypes.CUSTOM_NAME, Utils.MM.deserialize("Creation Splitter"))
            }
