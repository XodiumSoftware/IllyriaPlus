...
/** Represents a Watching Warglaive. */
internal object WatchingWarglaiveItem : ItemInterface {
    override val key: NamespacedKey = NamespacedKey(instance, "watching_warglaive")
    ...
    override fun invoke(): ItemStack =
        ItemStack.of(Material.NETHERITE_SPEAR).apply {
            if (!hasData(DataComponentTypes.CUSTOM_NAME) && !hasData(DataComponentTypes.ITEM_NAME)) {
                setData(DataComponentTypes.CUSTOM_NAME, Utils.MM.deserialize("Watching Warglaive"))
            }
