...
/** Represents a Ashura's Blade. */
internal object AshurasBladeItem : ItemInterface {
    override val key: NamespacedKey = NamespacedKey(instance, "ashura_blade")
    ...
    override fun invoke(): ItemStack =
        ItemStack.of(Material.NETHERITE_SWORD).apply {
            if (!hasData(DataComponentTypes.CUSTOM_NAME) && !hasData(DataComponentTypes.ITEM_NAME)) {
                setData(DataComponentTypes.CUSTOM_NAME, Utils.MM.deserialize("Ashura's Blade"))
            }
